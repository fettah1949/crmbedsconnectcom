...
function getHotelName($HotelCode){
    $hotelList = DB::connection("mysql1")->table("Hotel_list");
    return $hotelList->where('Hotel_Code', $HotelCode)->value('Hotel_Name');
}
                ...
                <table id="style-1" class="table table-hover" style="width:100%">
                    ...
                    <thead>
                        ...
                        <th class="checkbox-column ck" ></th>
                            <th>Booking ID</th>
                            <th>Hotel</th>
                            <th style="display:none">Provider Name</th>
                            <th style="display:none">Costumer</th>
                            <th>Agency</th>
                            <th class="text-center" >Status</th>
                            <th class="mt">Booking Date</th>
                            <th>Check-In Date</th>
                            <th>Check-Out Date</th>
                            <th>Selling Price</th>
                            <th style="display:none">Purchasing Price</th>
                            <th style="display:none">Cancelation Date</th>
                            <th style="display:none">Cancelation Price</th>
                            <th>Currency</th> 
                    ...
                    <tbody>
                        @foreach($Reservations as $row)
                            <tr class='res_tab'>
                                ...
                                <td class='hotelCode' reservation-hotelCode = '{{  getHotelName( $row["hotelCode"] )}}'>{{ getHotelName($row["hotelCode"]) }}</td>
                                            ...
                                            @csrf
                                                <div class="row">
                                                    <div class="col-sm-2">
                                                        <div class="contact-name">
                                                            ...
                                                            <input type="text" id="c-tgx" name="c-tgx" class="form-control" readonly >
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="contact-email">
                                                            ...
                                                            <label for="c-hotelCode">Hotel</label>
                                                            <input type="text" id="c-hotelCode" name="c-hotelCode" class="form-control" readonly >
                                                            <span class="validation-text"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="contact-phone">
                                                            ...
                                                            <input type="text" id="c-bookingDate" name="c-bookingDate" class="form-control" readonly >
                                                            <span class="validation-text"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="contact-occupation">
                                                            ...
                                                            <input type="text" id="c-mainGuestName" name="c-mainGuestName" class="form-control" readonly >
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="contact-location">
                                                            ...
                                                            <label for="c-cancelation_date">Cancelation Date</label>
                                                            <input type="text" id="c-cancelation_date" name="c-cancelation_date" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="contact-location">
                                                            <i class="flaticon-location-1"></i>
                                                            <label for="c-cancelation_price">Cancelation Price</label>
                                                            <input type="text" id="c-cancelation_price" name="c-cancelation_price" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="contact-location">
                                                            <i class="flaticon-location-1"></i>
                                                            <label for="c-providerName">Fournisseur</label>
                                                                <select id="c-providerName" name="c-providerName" class="form-control">
                                                                    <option></option>
                                                                    @foreach($providers as $Prov)
                                                                        <option> {{ $Prov->Company_Name }} </option>
                                                                    @endforeach
                                                                </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="contact-location">
                                                            <i class="flaticon-location-1"></i>
                                                            <label for="c-CheckinDate">Checkin Date</label>
                                                            <input type="text" id="c-CheckinDate" name="c-CheckinDate" class="form-control" >
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="contact-location">
