                            ...
                            <div class="item-content">
                                <div class="user-profile">
                                    ...
                                    <div class="user-meta-info">
                                        <p class="user-name" data-name="Youssef">El Hachimi Youssef</p>
                                        <p class="user-work" data-occupation="IT">IT</p>
                                    </div>
                                </div>
                                <div class="user-email">
                                    <p class="info-title">Email: </p>
                                    <p class="usr-email-addr" data-email="usef.hach@gmail.com">usef.hach@gmail.com</p>
                                </div>
                                <div class="user-location">
                                    <p class="info-title">Location: </p>
                                    <p class="usr-location" data-location="Morocco">Morocco</p>
                                </div>
                                <div class="user-phone">
                                    <p class="info-title">Phone: </p>
                                    <p class="usr-ph-no" data-phone="+212 (620) 517-936">+212 (620) 517-936</p>
                                </div>
                                <div class="action-btn">
