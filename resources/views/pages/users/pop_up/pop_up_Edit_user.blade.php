<div class="modal fade" id="edit_user-{{ $id }}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop"
aria-hidden="true">
<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="deleteModalLabel2">Edit USER</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <i aria-hidden="true" class="ki ki-close"></i>
            </button>
        </div>
        <form class="text-left"  action="{{url('/admin/edit_user')}}" method="POST">
            @csrf
            <div class="form">
                ...
                <div id="username-field" class="field-wrapper input">
                    ...
                    <select required class="form-control "  id="role" name="role" >
                        <option value="">role</option>
                         ...
                         <option @if($role==2) selected  @endif value="2">agent</option>
