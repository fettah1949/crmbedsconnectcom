            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                @if ($page_name != 'alt_menu' && $page_name != 'blank_page' && $page_name != 'boxed' && $page_name != 'breadcrumb' )
                    ...
                    <li class="menu {{ ($category_name === 'contact') ? 'active' : '' }}">
                      ...
                      <li class="menu {{ ($category_name === 'vervotech') ? 'active' : '' }}">
                        <a href="#vervotech" data-active="{{ ($category_name === 'vervotech') ? 'true' : 'false' }}" data-toggle="collapse" aria-expanded="{{ ($category_name === 'vervotech') ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                                <span>vervotech</span>
                            </div>
                        ...
                        <ul class="collapse submenu list-unstyled {{ ($category_name === 'mappingvervotech') ? 'show' : '' }}" id="vervotech" data-parent="#vervotech">
                           
                                      
                            <li class="{{ ($page_name === 'vervotech') ? 'active' : '' }}">
                                <a href="{{ asset('/vervotech/liste') }}">Mapping </a>
                            </li>
