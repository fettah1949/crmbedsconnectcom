        ...
        @if (Auth::guard()->user()->role==1)
            ...
            <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                <div class="widget widget-chart-three">
                    ...
                    <input type="hidden" name="mois_{{$i}}_parans_ans_pre_plus_checkin" id="mois_{{$i}}_parans_ans_pre_plus_checkin"  @if(isset($records_prece_ans_pre_plus_checkin[$i]["total"])) value="{{$records_prece_ans_pre_plus_checkin[$i]["total"]}} " @else value="0" @endif/>
